...
readabilityHighT=read.csv("E:/Projects/SOContentQualityResources/FeatureValues/Case-B(TextCode)/CombinedLanguages/TextReadability/H1.csv", header = T)
readabilityHigh=read.csv("E:/Projects/SOContentQualityResources/FeatureValues/Case-B(TextCode)/CombinedLanguages/TextReadability/H1.csv", header = T)
readabilityLow=read.csv("E:/Projects/SOContentQualityResources/FeatureValues/Case-B(TextCode)/CombinedLanguages/TextReadability/L1.csv", header = T)


#High Total
nreadHighT=readabilityHighT$Score
summary(nreadHighT)

#High Random Sample
nreadHigh=readabilityHigh$Score
nreadHigh = nreadHigh[0:55300]
summary(nreadHigh)
...
axis(side=1,at=c(1.5,4.5,7.5,9.5,11.5,13.5),  labels= c("TPS vs DS","RPS vs DS","Q1","Q2","Q3","Q4"), cex.axis = 1.1)
